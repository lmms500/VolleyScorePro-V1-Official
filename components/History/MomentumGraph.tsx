  ...
  return (
    <div className="w-full bg-white dark:bg-white/5 rounded-3xl p-4 border border-black/5 dark:border-white/5 shadow-sm mt-4">
        ...
        {/* 
            ...
            1. overflow-x-auto: Enables horizontal scroll if content > container
            2. flex justify-center: Centers the content if content < container (prevents stretch)
        */}
        <div className="w-full overflow-x-auto custom-scrollbar pb-2">
            <div className="min-w-full flex justify-center h-72 sm:h-80 lg:h-96">
                <div 
                    className="relative h-full shrink-0 touch-none select-none" 
                    style={{ width: `${width}px` }} // Force calculated width
                >
                    <svg 
