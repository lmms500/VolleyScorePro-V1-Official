...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const base = "font-inter font-bold rounded-2xl flex items-center justify-center gap-2.5 outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500 select-none relative overflow-hidden disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 group isolate active:scale-95";
  
  const variants = {
    primary: "bg-indigo-600 text-white shadow-lg shadow-indigo-500/20 border border-indigo-400/20 hover:bg-indigo-500 ring-1 ring-inset ring-white/10",
    secondary: "bg-white/10 dark:bg-white/5 text-slate-700 dark:text-slate-200 border border-slate-200/50 dark:border-white/10 backdrop-blur-md hover:bg-white/20 dark:hover:bg-white/10",
