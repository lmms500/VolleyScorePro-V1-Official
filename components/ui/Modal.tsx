...
export const Modal: React.FC<ModalProps> = ({ 
  ...
  const bgClasses = `bg-white/90 dark:bg-[#020617]/85 backdrop-blur-3xl`;
            ...
            {shouldRenderHeader && (
                ...
                {showCloseButton && (
                    ...
                    className={`
                        ...
                        transition-all active:scale-90 border border-transparent hover:border-slate-200 dark:hover:border-white/10
                        ${isFullscreen ? 'mt-2' : ''}
                    `}
                    >
