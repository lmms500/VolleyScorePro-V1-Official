...
export const ProfileCreationModal: React.FC<ProfileCreationModalProps> = ({
    isOpen, onClose, onSave, initialName, initialNumber, initialSkill = 5, initialRole = 'none', initialAvatar, title
}) => {
    ...
    }, [isOpen, initialName, initialNumber, initialSkill, initialRole, initialAvatar]);
