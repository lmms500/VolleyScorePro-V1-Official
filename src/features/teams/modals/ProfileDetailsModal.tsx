...
export const ProfileDetailsModal: React.FC<ProfileDetailsModalProps> = ({
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full -mx-6 -mb-6 overflow-hidden bg-transparent glass-hardware-accelerated">
        
        {/* SCROLLABLE AREA */}
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 sm:p-8 pt-6 overflow-x-hidden">
            
            <div className="flex flex-col landscape:flex-row gap-6 sm:gap-8">
                
                {/* 1. HERO CARD (Left Column) */}
                <div className="w-full landscape:w-[40%] flex flex-col items-center landscape:sticky landscape:top-0">
        ...
        {/* 3. STICKY FOOTER */}
        <div className="mt-auto pt-4 border-t border-slate-200 dark:border-white/5 flex gap-3 px-6 sm:px-8 pb-6 sm:pb-8 bg-white dark:bg-[#0f172a] z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
