...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: "bg-gradient-to-br from-indigo-500 to-indigo-600 text-white shadow-[0_10px_15px_-3px_rgba(99,102,241,0.2),0_4px_6px_-4px_rgba(99,102,241,0.2),inset_0_1px_0_0_rgba(255,255,255,0.2)] border border-indigo-400/20 hover:from-indigo-400 hover:to-indigo-500 ring-1 ring-inset ring-white/10",
    ...
    success: "bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-[0_10px_15px_-3px_rgba(16,185,129,0.2),0_4px_6px_-4px_rgba(16,185,129,0.2),inset_0_1px_0_0_rgba(255,255,255,0.2)] border border-emerald-400/20 hover:from-emerald-400 hover:to-emerald-500 ring-1 ring-inset ring-white/10",
