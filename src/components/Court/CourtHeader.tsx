                ...
                <div className="flex items-center gap-3">
                    <div className="flex flex-col items-end">
                        <div className="flex items-center gap-1.5 mb-0.5">
                            ...
                            {servingTeam === 'A' && <div className="w-1.5 h-1.5 rounded-full bg-amber-500 dark:bg-amber-400 shadow-[0_0_8px_currentColor] animate-pulse" />}
                        </div>
                ...
                <div className="flex items-center gap-3 flex-row-reverse">
                    <div className="flex flex-col items-start">
                        <div className="flex items-center gap-1.5 mb-0.5 flex-row-reverse">
                            ...
                            {servingTeam === 'B' && <div className="w-1.5 h-1.5 rounded-full bg-amber-500 dark:bg-amber-400 shadow-[0_0_8px_currentColor] animate-pulse" />}
                        </div>
