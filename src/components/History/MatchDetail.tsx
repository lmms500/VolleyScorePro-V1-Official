...
import { 
  ArrowLeft, Activity, Crown, BarChart2, Zap, TrendingUp, Shield, Swords, Target, AlertTriangle, Sparkles
} from 'lucide-react';
            ...
            >
                {view === 'stats' ? (
                    <div className="space-y-6 pt-4 pb-20">
                        {/* HERO SCORE CARD */}
                         <div className="bg-white/60 dark:bg-white/[0.03] rounded-3xl p-6 border border-white/40 dark:border-white/5 shadow-sm backdrop-blur-md">
