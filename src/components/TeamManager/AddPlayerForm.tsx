        ...
        return (
            <div ref={containerRef} className="flex flex-col mt-4 animate-in fade-in slide-in-from-top-1 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-4 rounded-2xl border border-indigo-500/30 shadow-2xl shadow-indigo-500/10 ring-1 ring-indigo-500/20">
                <input
                    ref={inputRef}
                    autoFocus
                    className="w-full bg-slate-50/50 dark:bg-black/20 border-b border-white/20 dark:border-white/10 px-3 py-3 rounded-t-lg text-sm text-slate-900 dark:text-white focus:outline-none focus:bg-white/50 dark:focus:bg-white/5 font-bold placeholder:text-slate-400 mb-4 transition-colors"
