...
import { Globe, Menu, X, ArrowUp } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-rose-500/15 rounded-full blur-3xl" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <button onClick={() => scrollToSection('demo')} className="text-white/70 hover:text-white transition-colors text-sm font-medium">
                {t('landing.nav.demo')}
              </button>
              <button onClick={() => scrollToSection('about')} className="text-white/70 hover:text-white transition-colors text-sm font-medium">
                {t('landing.nav.about')}
              </button>
              <button onClick={() => scrollToSection('roadmap')} className="text-white/70 hover:text-white transition-colors text-sm font-medium">
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="px-4 py-4 space-y-3">
                <button onClick={() => scrollToSection('features')} className="block w-full text-left text-white/70 hover:text-white py-2 font-medium">
                  {t('landing.nav.features')}
                </button>
                <button onClick={() => scrollToSection('demo')} className="block w-full text-left text-white/70 hover:text-white py-2 font-medium">
                  {t('landing.nav.demo')}
                </button>
                <button onClick={() => scrollToSection('about')} className="block w-full text-left text-white/70 hover:text-white py-2 font-medium">
                  {t('landing.nav.about')}
                </button>
                <button onClick={() => scrollToSection('roadmap')} className="block w-full text-left text-white/70 hover:text-white py-2 font-medium">
                  {t('landing.nav.roadmap')}
                </button>
